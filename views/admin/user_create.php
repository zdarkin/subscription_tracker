...
$pageDescription = 'Create a new user account with credentials and roles.';
...
<div class="min-h-screen flex items-center justify-center px-4 py-8">
    <div class="w-full max-w-md animate-slide-up">
        ...
        <div class="text-center mb-6">
            <h1 class="text-2xl font-bold text-white mb-1">Create User Account</h1>
            <p class="text-gray-400 text-sm">Add a new user or administrator to the platform</p>
        </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="full_name" name="full_name" class="form-input pl-10"
                                placeholder="Full Name" value="<?= htmlspecialchars($old['full_name'] ?? '', ENT_QUOTES) ?>" required />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="username" name="username" class="form-input pl-10"
                                placeholder="username" value="<?= htmlspecialchars($old['username'] ?? '', ENT_QUOTES) ?>" required />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="relative">
                            ...
                            <input type="email" id="email" name="email" class="form-input pl-10"
                                placeholder="user@example.com" value="<?= htmlspecialchars($old['email'] ?? '', ENT_QUOTES) ?>" required />
                        </div>
                    </div>
                    ...
                    <!-- Submit -->
                    <button type="submit" class="btn-primary w-full mt-4">Create User Account</button>
                </div>
            </form>
        </div>
