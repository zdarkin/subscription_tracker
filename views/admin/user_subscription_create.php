...
$pageTitle       = "Add Subscription for " . htmlspecialchars($user['username'] ?? '', ENT_QUOTES);
$pageDescription = "Add a new recurring subscription on behalf of " . htmlspecialchars($user['username'] ?? '', ENT_QUOTES);
...
<main class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="flex items-center gap-4 mb-6">
        ...
        <div>
            ...
            <p class="text-gray-400 text-sm mt-0.5">Creating subscription for <strong><?= htmlspecialchars($user['username'], ENT_QUOTES) ?></strong></p>
        </div>
    </div>

    <!-- Form Card -->
    <div class="glass-card p-6 sm:p-8 animate-slide-up">
        <form method="POST" action="/admin/users/<?= $user['id'] ?>/subscriptions/create" id="subscriptionForm" novalidate>
